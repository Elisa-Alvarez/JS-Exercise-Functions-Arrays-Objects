...
console.log(makePersonObject(1,"potato", "email@email.com"));
/**
 * ### Challenge `getName`
 * 
 * @instructions
...
function getName(name) {
  /* code here */
     ...
     const nameIs= `Hello, my name is ${name}`;
...
// Data from file 
var data =[ { id: 1, car_make: "Lincoln", car_model: "Navigator", car_year: 2009 },
{ id: 2, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
{ id: 3, car_make: "Land Rover", car_model: "Defender Ice Edition", car_year: 2010 },
{ id: 4, car_make: "Honda", car_model: "Accord", car_year: 1983 },
{ id: 5, car_make: "Mitsubishi", car_model: "Galant", car_year: 1990 },
...
function getCarInfoByIndex(data, index) {
  ...
  for(let i=0; i<=data.length-1; i++){
    return `The is a ${data[index].car_make} ${data[index].car_model}`;
  }

  
}
console.log(getCarInfoByIndex(data,2));
...
return `This is a ${data.car_make} ${data.car_model}`
}
console.log(getLastCarInfo(data.pop()));
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(data,[id]) {
  ...
  for(let i=0; i<=data.length-1; i++){
    return `The is a ${data[id].car_make} ${data[id].car_model}`;
  }
